...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int orientation) {
        this(context, orientation, DIVIDER_TYPE_FULL, 0);
    }

    public DividerItemDecoration(Context context, int orientation, int dividerType, int indentWidth) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        int insetSize = dividerType == DIVIDER_TYPE_FULL ? 0 : CommonUtil.dipToPixels(indentWidth);
