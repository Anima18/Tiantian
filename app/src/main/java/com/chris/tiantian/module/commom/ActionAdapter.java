...
public class ActionAdapter extends RecyclerView.Adapter<ActionAdapter.ViewHolder> {
    ...
    public ActionAdapter(Context context, List<ActionMenuItem> dList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.listview_action_item, parent, false);
